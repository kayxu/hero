...
public class EquipPrototype{
	...
	float attackPiont;//攻击
	float defensePiont;//防御
	float liftPiont;//生命
	float soldierCount;//带兵数
	
	
	/**
	 * 最大累加数目	单格 默认为0 
	 */
	short maxStackCount = 0;
	 ...
	 */
	public void setAttackPiont(float attackPiont) {
	 ...
	 */
	public void setDefensePiont(float defensePiont) {
	 ...
	 */
	public void setLiftPiont(float liftPiont) {
	 ...
	 */
	public void setSoldierCount(float soldierCount) {
...
//		return "EquipPrototype [id=" + id + ", equipmentId=" + equipmentId
//				+ ", equipmentName=" + equipmentName + ", equipmentIcon="
//				+ equipmentIcon + ", equipmentType=" + equipmentType
//				+ ", equipmentLevel=" + equipmentLevel + ", qualityColor="
//				+ qualityColor + ", strengthenLevel=" + strengthenLevel
//				+ ", nextEquipmentId=" + nextEquipmentId + ", needLevel="
//				+ needLevel + ", buyPrice=" + buyPrice + ", sellPrice="
//				+ sellPrice + ", isSell=" + isSell + ", explain=" + explain
//				+ ", attackPiont=" + attackPiont + ", defensePiont="
//				+ defensePiont + ", liftPiont=" + liftPiont + ", soldierCount="
//				+ soldierCount + ", maxStackCount=" + maxStackCount + "]";
//	}
